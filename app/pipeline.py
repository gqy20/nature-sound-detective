...
def fuse_results(qwen: dict[str, Any], birdnet: dict[str, Any]) -> dict[str, Any]:
    ...
    # The general model is useful for MVP routing but its self-reported confidence is
    # not calibrated. Keep secondary labels out of the child-facing story and never
    # present a general-audio-only result as independently verified.
